...
router.post("/add-category", loginCheck, isAdmin, upload.any(), categoryController.postAddCategory);
router.post("/edit-category", loginCheck, isAdmin, upload.any(), categoryController.postEditCategory);
